...
const filteredStaff = [...staff]
  .filter((s) => {
    ...
    return (
      String(s.maintenance_staff_ID).toLowerCase().includes(searchTerm.toLowerCase()) ||
      String(s.maintenance_role).toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  .sort((a, b) => {
    ...
    if (sortField === "user_name" || sortField === "first_name") {
