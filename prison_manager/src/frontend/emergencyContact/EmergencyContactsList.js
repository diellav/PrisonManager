...
const EmergencyContactsList = ({ contacts, onEdit, onDelete, goToCreate }) => {
  ...
  const currentContacts = sortedContacts.slice(indexOfFirst, indexOfLast);
        ...
        <div className="card-body">
          ...
          <div className="table-responsive">
            <table className="table align-middle">
              <thead className="table-light">
                <tr>
                  {[
                    { field: "emergency_contact_ID", label: "ID" },
                    { field: "first_name", label: "First Name" },
                    { field: "last_name", label: "Last Name" },
                    { field: "date_of_birth", label: "Date of Birth" },
                    { field: "gender", label: "Gender" },
                    { field: "phone", label: "Phone" },
                    { field: "address_", label: "Address" },
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            <div className="small text-muted mb-2 mb-md-0">
              Showing {indexOfFirst + 1} to {Math.min(indexOfLast, sortedContacts.length)} of {sortedContacts.length} entries
            </div>
