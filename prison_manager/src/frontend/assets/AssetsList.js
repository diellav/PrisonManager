...
const AssetList = ({ assets, onEdit, onDelete, goToCreate }) => {
  ...
  return (
    <div>
      <div className="card shadow-sm mb-4 border-0">
        ...
        >
          <h4 className="m-0 text-primary fw-bold">Asset List</h4>
        ...
        <div className="card-body">
          ...
          <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            <div className="small text-muted mb-2 mb-md-0">
              ...
              {Math.min(indexOfLast, filteredAssets.length)} of {filteredAssets.length} entries
            </div>
