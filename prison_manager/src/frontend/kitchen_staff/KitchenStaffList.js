...
const KitchenStaffList = ({
  ...
  const [sortField, setSortField] = useState("kitchen_staff_ID");
  ...
  return (
    <div className="card shadow-sm mb-4 border-0">
      ...
      >
        <h4 className="m-0 text-primary fw-bold">Kitchen Staff List</h4>
      </div>
        ...
        <div className="table-responsive">
          <table className="table align-middle">
            <thead className="table-light">
              <tr>
                {[ 
                  { label: "ID", field: "kitchen_staff_ID" },
                  { label: "Staff name", field: "first_name" },
                  { label: "Role", field: "kitchen_role" },
                ].map(({ label, field }) => (
                  <th
                    key={field}
                ...
                {(hasPermission("kitchen_staff.edit") || hasPermission("kitchen_staff.delete")) && (
            ...
            <tbody>
              {currentStaff.length > 0 ? (
                currentStaff.map((s) => {
                  ...
                  return (
                    <tr key={s.kitchen_staff_ID}>
                      <td>{s.kitchen_staff_ID}</td>
                      <td>{userName}</td>
                      <td>{s.kitchen_role}</td>
                      {(hasPermission("kitchen_staff.edit") || hasPermission("kitchen_staff.delete")) && (
                        <td>
                          <div style={{ display: "flex", gap: "6px" }}>
                            {hasPermission("kitchen_staff.edit") && (
                              <button
...
export default KitchenStaffList;
