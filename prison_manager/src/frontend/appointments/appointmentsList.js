          ...
          <div className="table-responsive">
            <table className="table align-middle">
              <thead className="table-light">
                <tr>
                  <th onClick={() => handleSort("appointment_ID")} style={{ cursor: "pointer", backgroundColor: "#4E73DF", color: "white" }}>
                    ID {renderSortIcons("appointment_ID")}
                  </th>
                  <th onClick={() => handleSort("prisonerID")} style={{ cursor: "pointer", backgroundColor: "#4E73DF", color: "white" }}>
                    Prisoner {renderSortIcons("prisonerID")}
                  </th>
                  <th onClick={() => handleSort("medical_staff_ID")} style={{ cursor: "pointer", backgroundColor: "#4E73DF", color: "white" }}>
                    Medical Staff {renderSortIcons("medical_staff_ID")}
                  </th>
                  <th onClick={() => handleSort("date_")} style={{ cursor: "pointer", backgroundColor: "#4E73DF", color: "white" }}>
        ...
        <div className="modal show d-block" tabIndex="-1" role="dialog">
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">Are you sure you want to delete this appointment?</div>
