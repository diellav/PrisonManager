...
const addCell = async (req, res) => {
  try {
    const { block_name, capacity, actual_capacity, category } = req.body;
    await cellModel.createCell(block_name, capacity, actual_capacity, category);
...
const updateCell = async (req, res) => {
  try {
    const { block_name, capacity, actual_capacity, category } = req.body;
    await cellModel.updateCell(req.params.id, block_name, capacity, actual_capacity, category);
