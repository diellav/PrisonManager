...
const addCell = async (req, res) => {
  try {
    const { block_id, capacity, category, cell_number } = req.body;
    await cellModel.createCell(block_id, capacity, category, cell_number);
...
const updateCell = async (req, res) => {
  try {
    const { block_id, capacity, category, cell_number } = req.body;
    await cellModel.updateCell(req.params.id, block_id, capacity, category, cell_number);
